...
Step 2:
In the specification tab the user enters the safety properties for the power grid (i.e, upper and lower bound limit for power grid frequency) and set point value for the detection unit in the grid. 
